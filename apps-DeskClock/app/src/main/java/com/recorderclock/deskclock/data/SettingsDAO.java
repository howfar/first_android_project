...
package com.recorderclock.deskclock.data;
...
import com.recorderclock.deskclock.settings.ScreensaverSettingsActivity;
...
final class SettingsDAO {
     ...
     */
    static DataModel.CitySort getCitySort(Context context) {
        final int defaultSortOrdinal = DataModel.CitySort.NAME.ordinal();
        final SharedPreferences prefs = getSharedPreferences(context);
        final int citySortOrdinal = prefs.getInt(KEY_SORT_PREFERENCE, defaultSortOrdinal);
        return DataModel.CitySort.values()[citySortOrdinal];
    }
    ...
    static void toggleCitySort(Context context) {
        final DataModel.CitySort oldSort = getCitySort(context);
        final DataModel.CitySort newSort = oldSort == DataModel.CitySort.NAME ? DataModel.CitySort.UTC_OFFSET : DataModel.CitySort.NAME;
        final SharedPreferences prefs = getSharedPreferences(context);
     ...
     */
    static DataModel.ClockStyle getClockStyle(Context context) {
     ...
     */
    static DataModel.ClockStyle getScreensaverClockStyle(Context context) {
    ...
    private static DataModel.ClockStyle getClockStyle(Context context, String prefKey) {
        ...
        return DataModel.ClockStyle.valueOf(clockStyle.toUpperCase(Locale.US));
    }
